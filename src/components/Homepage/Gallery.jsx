      ...
      <div className="container mx-auto">
        ...
        {!showMore && (
          <button
            ...
            className="mt-4 translate-x-[36vw] font-semibold min-[900px]:translate-x-[40vw] px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors duration-300"
          >
            Show More
          </button>
        )}
