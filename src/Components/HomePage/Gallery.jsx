...
const Gallery = () => {
  ...
  return (
    <div className='pb-10 min-[1200px]:mt-[10%] pt-20 px-10 flex flex-col min-[1200px]:flex-row justify-center gap-10'>
      <motion.img
        ref={ref1}
        className='rounded-[20px] h-[170px] min-[1200px]:w-[50%] object-cover shadow-2xl shadow-black'
